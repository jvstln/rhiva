...
import { POOL_TABS } from "@/lib/mock/liquidity-data";
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-4 border-b border-border/70 px-6 pb-4">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button className="flex items-center gap-1 rounded-md border border-border/70 px-3 py-2 text-b-3 font-medium text-white">

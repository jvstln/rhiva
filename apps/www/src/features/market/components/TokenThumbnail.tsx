...
export function TokenThumbnail({
  ...
  return (
    <div className={cn("relative size-16 shrink-0", className)}>
      {badge && (
        <span className="-top-2 absolute left-0 z-10 rounded-full bg-black px-1.5 py-0.5 font-semibold text-b-6 text-white ring-1 ring-border">
          {badge}
        </span>
      )}
      ...
      <span className="-bottom-1.5 -right-1.5 absolute flex size-5 items-center justify-center rounded-full bg-surface-2 ring-1 ring-border">

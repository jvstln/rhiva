...
const navigationMenuTriggerStyle = cva(
  cn(
    "group/navigation-menu-trigger flex h-9 items-center rounded-lg px-2.5 py-1.5 text-sm font-medium transition-all outline-none hover:bg-muted focus:bg-muted focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-popup-open:bg-muted/50 data-popup-open:hover:bg-muted data-open:bg-muted/50 data-open:hover:bg-muted data-open:focus:bg-muted",
    "not-hover:not-focus:not-data-popup-open:not-data-active:text-muted-foreground",
  ),
);
  ...
  return (
    <NavigationMenuPrimitive.Portal>
      <NavigationMenuPrimitive.Positioner
        ...
        className={cn(
          "isolate z-50 h-(--positioner-height) w-(--positioner-width) max-w-(--available-width) transition-[top,left,right,bottom] duration-[0.35s] ease-[cubic-bezier(0.22,1,0.36,1)] data-instant:transition-none data-[side=bottom]:before:inset-e-0 data-[side=bottom]:before:inset-s-0 data-[side=bottom]:before:top-[-10px]",
          className,
        )}
        {...props}
      >
